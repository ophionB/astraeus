...
/**
 * A simple timing utility used to throttle or time actions. This class has been altered to use
 * <code>NANOSECONDS</code> for extremely accurate timing.
 * 
 * @author lare96
 */
public class Stopwatch {
  ...
  /**
   * Returns the amount of time elapsed since this object was initialized, or since the last call to
  ...
  /**
   * Returns the amount of time elapsed since this object was initialized, or since the last call to
   * the <code>reset()</code> method in <code>unit</code>.
   * 
  ...
  /**
   * Resets the internal cached time, but instead of resetting it to <tt>0</tt> it resets it to
   * start at <code>start</code>.
   * 
   * @param start the time to start this stopwatch at.
   * @return the stopwatch instance.
   */
