package com.astraeus.game.task.impl;
...
public abstract class DistancedTask extends Task {
   ...
   * 
   * @param distance The distance in tiles before {@link #onReached()} can execute.
   */
   ...
   * @param distance The distance in tiles before {@link #onReached()} can execute.
   * 
   * @param delay The delay in game ticks the task sleeps for.
   */
   ...
   * @param distance The distance in tiles before {@link #onReached()} can execute.
   * 
   * @param immediate The flag that denotes to execute this task immediately instead of being
   *        queued.
   */
   ...
   * Creates a new {@link DistancedTask}.
   * 
   * @param player The starting position
   * 
   * @param destination The ending position
   * 
   * @param distance The distance in tiles before {@link #onReached()} can execute.
