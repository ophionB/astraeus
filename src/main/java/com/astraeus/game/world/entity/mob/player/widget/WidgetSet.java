package com.astraeus.game.world.entity.mob.player.widget;

import java.util.HashMap;
import java.util.Map;

import com.astraeus.game.world.entity.mob.player.Player;
import com.astraeus.net.packet.out.DisplayChatBoxWidgetPacket;
import com.astraeus.net.packet.out.DisplayInventoryWidgetPacket;
import com.astraeus.net.packet.out.DisplayWidgetPacket;
