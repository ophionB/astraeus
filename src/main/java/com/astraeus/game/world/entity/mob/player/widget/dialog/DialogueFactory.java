package com.astraeus.game.world.entity.mob.player.widget.dialog;
...
import com.astraeus.net.packet.out.DisplayNpcHeadModelOnWidgetPacket;
import com.astraeus.net.packet.out.DisplayPlayerHeadModelOnWidgetPacket;
import com.astraeus.net.packet.out.RemoveWidgetPacket;
import com.astraeus.net.packet.out.SetWidgetAnimationPacket;
...
public final class DialogueFactory {
  ...
  final DialogueFactory sendPlayerChat(PlayerDialogue dialogue) {
    ...
    switch (lines.length) {
      case 1:
        ...
        player.queuePacket(
            new SetWidgetStringPacket(StringUtils.formatName(player.getUsername()), 970));
      ...
      case 2:
        ...
        player.queuePacket(
            new SetWidgetStringPacket(StringUtils.formatName(player.getUsername()), 975));
      ...
      case 3:
        ...
        player.queuePacket(
            new SetWidgetStringPacket(StringUtils.formatName(player.getUsername()), 981));
      ...
      case 4:
        ...
        player.queuePacket(
            new SetWidgetStringPacket(StringUtils.formatName(player.getUsername()), 988));
      ...
      default:
        logger.log(Level.SEVERE,
            String.format("Invalid player dialogue line length: %s", lines.length));
        break;
    }
    return this;
  }
   ...
   */
  public final DialogueFactory sendOption(String option1, Runnable action1, String option2,
      Runnable action2) {
  ...
  public final DialogueFactory sendOption(String option1, Runnable action1, String option2,
    ...
    return append(new OptionDialogue(option1, action1, option2, action2, option3, action3, option4,
