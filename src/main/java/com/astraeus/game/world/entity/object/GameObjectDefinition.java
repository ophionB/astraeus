...
public class GameObjectDefinition {
   ...
   */
  private static final GameObjectDefinition[] definitions =
      new GameObjectDefinition[GAME_OBJECT_LIMIT];
   ...
   * 
   * @param index The index of the object to lookup.
   * 
  ...
  public GameObjectDefinition(int id, String name, String description, int length, int width,
      boolean solid, boolean impenetrable, boolean interactive, boolean obstructive,
      String[] options) {
    this.id = id;
    this.name = name;
