...
public class ChannelFilter extends ChannelInboundHandlerAdapter {
  ...
  /**
   * Sends a {@code response} back to the user logging in indicating something went wrong. Then
   * prepares to disconnect the user from the server.
   *
   * @param ctx The context of this channel.
   *
   * @param response The response code that is being sent.
   */
