package io.battlerune.game.model;
...
public enum Direction {
  ...
  @Getter private final int directionX;

  @Getter private final int directionY;
   ...
   * 
   * @param directionX The value that represents a direction.
   */
   ...
   * 
   * @param location The location that will be the viewpoint.
   * 
   * @param other The other location to get the direction of.
   * 
  ...
  /**
   * Gets the Manhattan direction of an orientation. Manhattan direction does not support diagnal
   * directions, so the orientation must be between [0, 3] inclusive.
   * 
   * @param orientation
   * @return
   */
