package io.battlerune.game.model.entity.mob.combat.def;
...
import io.battlerune.net.packet.out.SetWidgetVisibilityPacket;
import io.battlerune.net.packet.out.UpdateSpecialAmountPacket;
