package io.battlerune.game.model.entity.mob.npc;
...
public final class NpcDefinition {
  ...
  public NpcDefinition(int id, String name, int combatLevel, int size, int standAnimation,
      int walkAnimation, int turn180Animation, int turn90CWAnimation, int turn90CCWAnimation,
      int attack, int block, int death) {
    this.id = id;
    this.name = name;
