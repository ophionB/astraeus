...
import io.battlerune.net.packet.out.AddFriendPacket;
import io.battlerune.net.packet.out.AddIgnorePacket;
import io.battlerune.net.packet.out.SendPrivateMessagePacket;
import io.battlerune.net.packet.out.ServerMessagePacket;
import io.battlerune.net.packet.out.SetFriendListStatusPacket;
