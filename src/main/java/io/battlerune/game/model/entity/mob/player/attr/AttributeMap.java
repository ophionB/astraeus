package io.battlerune.game.model.entity.mob.player.attr;
...
public final class AttributeMap {
  ...
  /**
   * Returns the value of the attribute which is represented by the specified {@link AttributeKey},
   * if no key exists the initial value is returned and the key is added.
   *
  ...
  /**
   * Sets a specified attribute key to a specified value and returns the value.
   *
   * @param <T> The attributes value type reference.
   * @param key The attribute key, may not be {@code null}.
  ...
  /**
   * Returns a flag which denotes whether or not an attribute key exists within the {@link #attrs}
   * map.
   *
   * @param <T> The attributes value type reference.
   * @param key The attribute key, may not be {@code null}.
   * @return {@code true} if and only if the specified key exists within the attribute map,
