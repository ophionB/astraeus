package io.battlerune.game.model.location;
...
public abstract class Area {
   ...
   * 
   * @return {@code true} If the specified location is within an area. {@code false} otherwise.
   */
   ...
   *
   * @param area The areas to check.
   * 
   * @return {@code true} If an entity is in all of these areas. {@code false} otherwise.
   */
   ...
   * @param area The areas to check.
   * 
   * @return {@code true} If an entity is in any of these areas. {@code false} otherwise.
   */
   ...
   * @param entity The entity to check.
   * 
   * @return {@code true} If this entity is in the wilderness. {@code false} otherwise.
   */
