package io.battlerune.game.model.widget;

import java.util.HashMap;
import java.util.Map;

import io.battlerune.game.model.entity.mob.player.Player;
import io.battlerune.net.packet.out.DisplayChatBoxWidgetPacket;
import io.battlerune.net.packet.out.DisplayInventoryWidgetPacket;
import io.battlerune.net.packet.out.DisplayWidgetPacket;
