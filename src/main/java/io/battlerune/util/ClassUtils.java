...
/**
 * A static-utility class containing extension or helper methods for {@link Class}es or generic
 * objects.
 *
...
public final class ClassUtils {
  ...
  /**
   * Suppresses the default-public constructor preventing this class from being instantiated by
   * other classes, instantiating this class from within itself will throw an
   * {@link UnsupportedOperationException}.
   *
   * @throws UnsupportedOperationException If this class is instantiated from within itself.
   */
  private ClassUtils() {
