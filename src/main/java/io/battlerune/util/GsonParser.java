...
/**
 * This class provides an easy to use google gson parser specifically designed for parsing JSON
 * files.
 *
 * @author Seven
 */
public abstract class GsonParser extends GenericParser {
   ...
   *
   * @param data The {@link JsonObject} that contains all serialized information.
   */
