...
public final class RandomUtils {
  ...
  /**
   * Generates an inclusive pseudo-random number with (approximately) equal probability. This random
   * number has a minimum value of {@code 0} and a maximum of {@code max}.
   *
  ...
  /**
   * Generates a pseudo-random number with (approximately) equal probability. This random number has
   * a minimum value of {@code 0} and a maximum of {@code max}.
   *
   * @param max The maximum value.
   *
