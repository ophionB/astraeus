...
public class EquipmentUpdater {
	...
	public static void main(String[] args) {
		...
		for (ItemDefinition def : ItemDefinition.definitions) {
			...
			equipDefs.add(new EquipmentDefinition(id, name, type,
					requirements.stream().toArray(SkillRequirement[]::new), fullBody, fullHat, fullMask, bonuses));
	 ...
	 * Bodies.
	 */
	public static final String[] BODY = {"platebody", "chainbody", "robetop", "leathertop", "platemail",
			"brassard", "robe top", "body", "chestplate", "torso", "shirt" };
	 ...
	 * Hats.
	 */
	public static final String[] HATS = { "tiara", "hood", "coif", "partyhat", "hat",
			"cavalier", "boater", "helmet"};
	 ...
	 * Shields.
	 */
	public static final String[] SHIELDS = {"kiteshield", "sq shield", "toktz-ket", "books", "book",
			"kiteshield", "defender", "shield"};

	/**
	 * Weapons.
	 */
	public static final String[] WEAPONS = { "scimitar", "longsword", "sword", "longbow", "shortbow", "crossbow",
			"dagger", "mace", "halberd", "spear", "abyssal whip", "axe", "flail", "torags hammers", "maul", "dart",
			"javelin", "knife", "toktz-xil", "toktz-mej", "tzhaar-ket", "staff", "godsword", "c'bow",
			"crystal bow", "dark bow", "magic butterfly net"};
